...
namespace LineComparisonProblems
{
    public class CompareTwoLines
    {
        public void compareTwoLines()
        {
            ...
            Console.WriteLine("The lenght of the line is One is = {0} ", lenght);
            ...
            Console.WriteLine("The lenght of the line Two is = {0} ", lenght2);
            ...
            else if (lenght > lenght2)
            {
                ...
                Console.WriteLine("The line Two is less than line One");
            }
            else
            {
                Console.WriteLine("The line Two is greater than line One");
